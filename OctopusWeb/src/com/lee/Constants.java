...
public class Constants  {
    ...
    //luzeyi
    public static final byte WAIT_TIME = 1;
    
    //mysql
    public static final String MYSQL_CLASSNAME = "com.mysql.jdbc.Driver";
    public static final String MYSQL_CONNECTION = "jdbc:mysql://localhost/octopus?useUnicode=true&characterEncoding=GBK";
    public static final String MYSQL_USERNAME = "root";
    public static final String MYSQL_PASSWORD = "6335180";
}
